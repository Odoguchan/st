...
/* static char *font = "Input Mono:pixelsize=11.5:antialias=true:autohint=true"; */
/* static char *font = "Input Mono Compressed:sytle=Regular:pixelsize=12:autohint=true:antialias=true"; */
/* static char *font = "FantasqueSansMono NF:sytle=Regular:pixelsize=13:autohint=true"; */
/* static char *font = "Input Mono Compressed:sytle=Regular:autohint=
true"; */
static char *font = "Iosevka Term:pixelsize=12:autohint=true";

static char *font2[] = {
    /* "Symbols Nerd Font:pixelsize=12:antialias=true:autohint=true" */
    /* "Iosevka Mono:pixelsize=12:antialias=true:autohint=true" */
    /* "UbuntuMono Nerd Font Complete Mono:pixelsize=16:antialias=true:autohint=true" */
...
static const char *palettes[][16] = {
    ...
    /* bg_0, red, green, yellow, blue, magenta, cyan, fg_1, */
    /* bg_1, br_red, br_green, br_yellow, br_blue, br_magenta, br_cyan, fg_0 */

    /* https://github.com/jan-warchol/selenized/blob/master/the-values.md */
    /* selenized-white */
    {"#474747", "#d6000c", "#1d9700", "#c49700", "#0064e4", "#dd0f9d", "#00ad9c", "#cdcdcd",
     "#878787", "#bf0000", "#008400", "#af8500", "#0054cf", "#c7008b", "#009a8a", "#ffffff"},

    /* selenized-dark */
    {"#b9b9b9", "#ed4a46", "#70b433", "#dbb32d", "#368aeb", "#eb6eb7", "#3fc5b7", "#dedede",
     "#252525", "#ff5e56", "#83c746", "#efc541", "#4f9cfe", "#ff81ca", "#56d8c9", "#181818"},

    /* selenized-light */
    {"#3a4d53", "#d2212d", "#489100", "#ad8900", "#0072d4", "#ca4898", "#009c8f", "#d5cdb6",
     "#909995", "#cc1729", "#428b00", "#a78300", "#006dce", "#c44392", "#00978a", "#fbf3db"},

    /* selenized-dark */
    {"#cad8d9", "#fa5750", "#75b938", "#dbb32d", "#4695f7", "#f275be", "#41c7b9", "#184956",
     "#72898f", "#ff665c", "#84c747", "#ebc13d", "#58a3ff", "#ff84cd", "#53d6c7", "#2d5b69"},
    ...
    /* gruvbox-light */
    {"#282828", "#cc241d", "#98971a", "#d79921", "#458588", "#b16286", "#689d6a", "#928374",
     "#3c3836", "#9d0006", "#79740e", "#b57614", "#076678", "#8f3f71", "#427b58", "#fbf1c7"},

    /* gruvbox-dark */
    {"#ebdbb2", "#cc241d", "#98971a", "#d79921", "#458588", "#b16286", "#689d6a", "#7c6f64",
     "#a89984", "#fb4934", "#b8bb26", "#fabd2f", "#83a598", "#d3869b", "#8ec07c", "#282828"},

    /* dracula */
    {"#bbbbbb", "#ff5555", "#50fa7b", "#f1fa8c", "#bd93f9", "#ff79c6", "#8be9fd", "#000000",
     "#ffffff", "#ff5555", "#50fa7b", "#f1fa8c", "#bd93f9", "#ff79c6", "#8be9fd", "#44475a"},

    {"#eaeaea", "#b7141f", "#457b24", "#fc7b08", "#134eb2", "#560088", "#0e717c", "#777777",
     "#424242", "#e83b3f", "#7aba3a", "#fd8e09", "#54a4f3", "#aa4dbc", "#26bbd1", "#aaaaaa"},

    {"#000000", "#cc0403", "#19cb00", "#cecb00", "#0d73cc", "#cb1ed1", "#0dcdcd", "#ffffff",
     "#767676", "#f2201f", "#23fd00", "#fffd00", "#1a8fff", "#fd28ff", "#14ffff", "#dddddd"},

    {"#222233", "#990000", "#008800", "#ffee77", "#3355ee", "#ffcc55", "#1188ee", "#aaaaaa",
     "#666666", "#ff2255", "#00bb00", "#ffff66", "#4466ff", "#dd66aa", "#66bbff", "#dddddd"},
